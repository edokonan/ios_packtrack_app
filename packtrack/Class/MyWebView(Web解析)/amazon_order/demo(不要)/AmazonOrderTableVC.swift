...
class AmazonOrderTableVC: UITableViewController {
    
    var model :AmazonOrdersModel? = nil
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return model!.Orders_Amazon.count
    }
...
//        case 0:
        ...
        cell.setUI((model?.Orders_Amazon[indexPath.row])!)
            cell.selectionStyle = .none
            return cell
//        default:
//            let cell = self.tableView.dequeueReusableCell(withIdentifier: cellId, for: indexPath) as! AmazonOrderCell
//            cell.setUI(model.Orders_Amazon[indexPath.row])
//            cell.selectionStyle = .none
//            return cell
//        }
