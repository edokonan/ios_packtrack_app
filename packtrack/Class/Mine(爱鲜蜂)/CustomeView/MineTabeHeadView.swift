...
class MineOrderView: UIView {
    ...
    override init(frame: CGRect) {
        super.init(frame: frame)
        btn = MineUpImageDownText(frame: CGRect.zero, title: "バックアップ", imageName: "icons8-upload-to-the-cloud")
        addSubview(btn)
    }
...
class MineCouponView: UIView {
    ...
    override init(frame: CGRect) {
        super.init(frame: frame)
        btn = MineUpImageDownText(frame: CGRect.zero, title: "リストア", imageName: "icons8-download-from-the-cloud")
        addSubview(btn)
    }
...
class MineMessageView: UIView {
    ...
    override init(frame: CGRect) {
        super.init(frame: frame)
        btn = MineUpImageDownText(frame: CGRect.zero, title: "再配達", imageName: "icons8-delivery")
        addSubview(btn)
    }
